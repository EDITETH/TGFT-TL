...
function targetless.Controller:generatetotals()
    ...
    targetless.Controller.totals.guard = iup.label { title="0", fgcolor="155 155 155", font=targetless.var.font }
    targetless.Controller.totals.stturret = iup.label { title="0", fgcolor="155 155 155", font=targetless.var.font }

    targetless.Controller.totals.pvplabel = iup.label { title="PvP:", fgcolor=FactionColor_RGB[GetPlayerFaction()], font=targetless.var.font }
    targetless.Controller.totals.pvelabel = iup.label { title="PvE: (", fgcolor=FactionColor_RGB[GetPlayerFaction()], font=targetless.var.font }
    targetless.Controller.totals.pveblabel = iup.label { title=")", fgcolor=FactionColor_RGB[GetPlayerFaction()], font=targetless.var.font }
    targetless.Controller.totals.orelabel = iup.label { title="Ore:", fgcolor=FactionColor_RGB[GetPlayerFaction()], font=targetless.var.font }
    targetless.Controller.totals.guardlabel = iup.label { title="Grd:", fgcolor=FactionColor_RGB[GetPlayerFaction()], font=targetless.var.font }
    targetless.Controller.totals.stturretlabel = iup.label { title="Tur:", fgcolor=FactionColor_RGB[GetPlayerFaction()], font=targetless.var.font }
    ...
    elseif(self.mode == "Ore") then  self.totals.roids.fgcolor = "255 255 255"
    elseif (self.mode == "Guard") then
      self.totals.guard.fgcolor = "255 255 255"
      self.totals.guardlabel.fgcolor = "255 255 255"
    elseif (self.mode == "StTurret") then
      self.totals.stturret.fgcolor = "255 255 255"
      self.totals.stturretlabel.fgcolor = "255 255 255"
    end
    ...
    iup.Append(iupbox,iup.label{title="|",fgcolor="155 155 155",font=targetless.var.font})
    iup.Append(iupbox,iup.fill { size="3" })
    iup.Append(iupbox,self.totals.guardlabel)
    iup.Append(iupbox,self.totals.guard)
    iup.Append(iupbox,iup.fill { size="3" })
    iup.Append(iupbox,iup.label{title="|",fgcolor="155 155 155",font=targetless.var.font})
    iup.Append(iupbox,iup.fill { size="3" })
    iup.Append(iupbox,self.totals.stturretlabel)
    iup.Append(iupbox,self.totals.stturret)
...
function targetless.Controller:updatetotals()
  if targetless.Controller.autox == 'autoxactive' then
    gkinterface.GKProcessCommand('RadarNextNearestEnemy')
  end
    ...
    self.totals.guard.title = ""..self.currentbuffer.count.guard
    self.totals.stturret.title = ""..self.currentbuffer.count.stturret
end
